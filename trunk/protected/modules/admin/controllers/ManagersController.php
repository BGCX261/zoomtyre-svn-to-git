...
class ManagersController extends AController
{
	
	public function actions(){
		return array(
			'ajaxUsers'=> 'admin.controllers.actions.ajaxAutocompleteUsersAction',
			'ajaxManagers'=> 'admin.controllers.actions.ajaxAutocompleteManagersAction',
		);
	}
