...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->label($model,'publicated'); ?>
		<?php echo $form->textField($model,'publicated'); ?>
	</div>

	<div class="row">
		<?php echo $form->label($model,'preamble'); ?>
		<?php echo $form->textArea($model,'preamble',array('rows'=>6, 'cols'=>50)); ?>
	</div>

	<div class="row">
		<?php echo $form->label($model,'preamble_marked'); ?>
		<?php echo $form->textArea($model,'preamble_marked',array('rows'=>6, 'cols'=>50)); ?>
	</div>
