...
<div id='<?php echo $this->id;?>ImageUpload' style='display: none;'>
	...
	<div class='row'>
		...
		<?php echo CHtml::textField('alt', 'Альтернативный текст', array('class'=>'alt', 'size'=>48)); ?>
	</div>
	<div class='row'>
		<label>Подсказка</label>
		<?php echo CHtml::textField('title', 'Подсказка', array('class'=>'title', 'size'=>48)); ?>
	</div>
	<div class='row'>
		<label>Подпись</label>
		<?php echo CHtml::textArea('signature', 'Подпись', array('class'=>'signature', 'cols'=>37)); ?>
	</div>
