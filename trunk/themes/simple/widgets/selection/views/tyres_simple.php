...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row producers">
		<label><b>Производители шин</b> <i class='control'>определённые</i></label>
		<?php echo $form->checkBoxList($tyreSelection,'producers', CHtml::listData(TyreProducers::model()/*->with('tyres.sizes:inSight')*/->findAll(), 'alias', 'title'), array('template'=>'<span>{input} {label}</span>', 'separator'=>'' )); ?>
	...
	<div class="row">
		...
		<?php echo $form->dropDownList($tyreSelection,'season', L::items('tyreSeason'), array( 'empty'=>'Неважно' )); ?>
