...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row producers">
		<label><b>Производители дисков</b> <i class='control'>определённые</i></label>
		<?php echo $form->checkBoxList($diskSelection,'producers', CHtml::listData(DiskProducers::model()->/*with('disks.sizes:inSight')->*/findAll(), 'alias', 'title'), array('template'=>'<span>{input} {label}</span>', 'separator'=>'' )); ?>
