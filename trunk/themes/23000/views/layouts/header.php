<div id="header">
	...
	<div class="wrapper">
		...
		<div class="banner right">
			<a href="<?php echo CHtml::normalizeUrl(array('index/contact'));?>" class='phone'><?php echo Yii::app()->params['phone']; ?></a>
			<a href="<?php echo CHtml::normalizeUrl(array('index/contact'));?>"><?php echo Yii::app()->params['address']; ?></a>
			<a href="<?php echo CHtml::normalizeUrl(array('installation/index'));?>">Шиномонтажи</a>
		</div>
	</div>
